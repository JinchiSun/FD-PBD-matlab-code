function PBD_iso_r0 = PBD_iso(ff)
...
% the bulk material has isotropic elastic and thermal expansion properties

% this difference of this code with the function PBD_isofree is that
% in this code, the effect of Al coating on surface deformation is included
...
C11_2_p = (C11_2 + C12_2 + 2*C44_2)/2;
C33_2_p = (C11_2 + 2*C12_2 + 4*C44_2)/3;
C44_2_p = (C11_2 - C12_2 + C44_2)/3;
C12_2_p = (C11_2 + 5*C12_2 - 2*C44_2)/6;
C13_2_p = (C11_2 + 2*C12_2 - 4*C44_2)/3;
C46_2_p = 0;
C22_2_p = C11_2_p;
C23_2_p = C13_2_p;
C55_2_p = C44_2_p;
C66_2_p = (C11_2_p - C12_2_p)/2;
beta_3 = (C11_2 + 2*C12_2)*alphaT_3;
betax_2 = beta_3;
betay_2 = beta_3;
betaz_2 = beta_3;
...
C11_3 = E_3*(1-niu_3)/(1+niu_3)/(1-2*niu_3);
C12_3 = E_3*niu_3/(1+niu_3)/(1-2*niu_3);
C44_3 = E_3/2/(1+niu_3);
beta_3 = (C11_3 + 2*C12_3)*alphaT_3;

C12C11_3 = C12_3/C11_3;
C44C11_3 = C44_3/C11_3;
sqrtC11rho_3 = sqrt(C11_3/rho_3);
...
for i_fr = 1:length(ff)
    ...
    PBD_iso_r0(i_fr,1) = C_probe/pi*simpson_inte(I_p2,d_p);
end
