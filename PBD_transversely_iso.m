function PBD_ani_r0 = PBD_transversely_iso(ff)
...
% the bulk material has transversely isotropic heat transfer, elastic, and thermal expansion properties
...
sqrtC11rho_2 = sqrt(C11_2_p/rho_3);
...
% 3: MoS_2
sigma_3_z = 4.75;
sigma_3_r_z = 80.0/4.75; % sigma_3_r/sigma_3_z
capac_3 = 1.91e6;
...
C55_3 = C44_3;
C66_3 = (C11_3 - C12_3)/2;
alphaT_vertical = 5.8e-6;
alphaT_parallel = 11.3e-6;
rho_3 = 5.06e3;

betax_3 = (C11_3 + C12_3)*alphaT_vertical + C13_3*alphaT_parallel;
betay_3 = betax_3;
betaz_3 = 2*C13_3*alphaT_vertical + C33_3*alphaT_parallel;
C22C11_3 = C22_3/C11_3;
C33C11_3 = C33_3/C11_3;
C12C11_3 = C12_3/C11_3;
C13C11_3 = C13_3/C11_3;
C23C11_3 = C23_3/C11_3;
C44C11_3 = C44_3/C11_3;
C55C11_3 = C55_3/C11_3;
C66C11_3 = C66_3/C11_3;
sqrtC11rho_3 = sqrt((1+(1e-6)*(1i))*C11_3/rho_3);
betaxC11_3 = betax_3/C11_3;
betayC11_3 = betay_3/C11_3;
betazC11_3 = betaz_3/C11_3;
...
for i_fr = 1:length(ff)
    ...
    for i_p = 1:n_p
        ...
        A_3(1,3) = C13C11_3*(1i)*k;
        A_3(2,3) = C23C11_3*(1i)*xi;
        B_3(1,1) = k^2 + C66C11_3*xi^2 - omega^2/sqrtC11rho_3^2;
        B_3(2,2) = C22C11_3*xi^2 + C66C11_3*k^2 - omega^2/sqrtC11rho_3^2;
        B_3(1,2) = (C12C11_3 + C66C11_3)*k*xi;
        B_3(2,1) = (C12C11_3 + C66C11_3)*k*xi;
        B_3(3,3) = -omega^2/sqrtC11rho_3^2;
        B_3(3,4) = -(1i)*k;
        B_3(3,5) = -(1i)*xi;
        B_3(4,3) = -C55C11_3*(1i)*k;
        B_3(5,3) = -C44C11_3*(1i)*xi;
        B_3(6,1) = -C13C11_3*(1i)*k;
        B_3(6,2) = -C23C11_3*(1i)*xi;
        D_3(1) = betaxC11_3*(1i)*k;
        D_3(2) = betayC11_3*(1i)*xi;
        inv_A_3 = inv(A_3);
        N_3 = inv_A_3*D_3;
        ...
        w_s_P = sssum;
        Z_iso_p_omega = -(w_s_H + w_s_P);
        I_p2(i_p) = Z_iso_p_omega*exp(-w0^2*p^2/8)*(-besselj(1,p*r0))*p^2;
    end
    PBD_ani_r0(i_fr,1) = C_probe/pi*simpson_inte(I_p2,d_p);
end
